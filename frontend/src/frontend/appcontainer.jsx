...
import FreelancerAppliedJob from "./components/forfreelancer/appliedJob/index.jsx";
import FreelancerAppliedProject from "./components/forfreelancer/appliedProject/index.jsx";
...
import CompanyPostedJob from "./components/foremployers/postedJob/index.jsx";
          ...
          <>
            ...
            <div className="about-us-page">
              <Switch>
                ...
                <Route
                  exact
                  path="/freelancer-applied-job"
                  component={FreelancerAppliedJob}
                />

                <Route
                  exact
                  path="/freelancer-applied-project"
                  component={FreelancerAppliedProject}
                />
                ...
                {/* <Route exact path="/error" component={ErrorModal} /> */}
                <Route
                  exact
