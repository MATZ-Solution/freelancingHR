...
<head>
  ...
  ">Hi <span style="color: #1672BA;font-weight: 700; font-size: 25px;"><b>${name}</b></span>,</h1>
                <p class="near_title last" style="margin-top: 10px;margin-bottom: 0; color: gray; font-family: figtree;">Please verify that your email address , and that you entered it when signing up for Xgen Technologies Freelance.</p>
  ...
  background: #F4FBF9;">
    ...
    vertical-align: top;
      border: none !important;
  padding: 20px;">
                <p class="marginless" style="margin: 0; font-family: figtree;">Thank You, <br>Xgen Technologies </p>
              </td>
            </tr>
          </tbody></table>
        </td>
  ...
  ">
    ...
    line-height: 1.5;
  ">
          If you did not enter this email address when signing up for Xgen Technologies Freelance service, disregard this message.<br><br>
          Plot 13C, V Stadium Lane 2, Phase Stadium Commercial Area Defence V Defence Housing Authority, Karachi, Karachi City, Sindh 75500
  <br><br>
  
  This is a mandatory service email from Xgen Technologies Freelance.
  </p>
        </td>
      </tr>
    </tbody></table>
...
exports.welcome = (name) => {
  return `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
    ...
    <tr class=""><td class="headline">Welcome <b>${name}</b> to Xgen Technologies Freelance!</td></tr>
    <tr>
    <td>
    <center class=""><table cellpadding="0" cellspacing="0" class="" style="margin: 0 auto;" width="75%"><tbody class=""><tr class="">
    <td class="" style="color:#444; font-weight: 400;"><br><br>
